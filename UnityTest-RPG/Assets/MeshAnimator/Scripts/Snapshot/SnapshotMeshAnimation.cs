...
namespace FSG.MeshAnimator.Snapshot
{
    ...
    public class SnapshotMeshAnimation : MeshAnimationBase
    {
        ...
        [HideInInspector] public DeltaCompressedFrameData compressedFrameData;
        ...
        private void Awake() { decompressedFrameData = null; }
        ...
        public override void SetFrameData(MeshFrameDataBase[] frameData)                            { decompressedFrameData = new SnapshotMeshFrameData[frameData.Length]; }
        ...
        private void CheckFullGeneration(int newFrame)
        {
            ...
            if (generatedMeshes.Length <= newFrame) return;
